...
export default class Startup extends Component{
    ...
    componentDidMount(){
     axios.get("https://cors-anywhere.herokuapp.com/http://newsfeedbuzz.herokuapp.com/startup")
     .then(response => {
         console.log(response.data)
         this.setState({startup: response.data})
     })
     .catch((error)=>{
         console.log(error)
     })
    ...
    render(){
        let articleList = this.state.startup.map((article,index) => {
            return (
