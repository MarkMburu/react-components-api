...
export default class Politics extends Component{
    ...
    componentDidMount(){
     axios.get("https://cors-anywhere.herokuapp.com/http://newsfeedbuzz.herokuapp.com/politics")
     .then(response => {
         console.log(response.data)
         this.setState({politics: response.data})
     })
     .catch((error)=>{
         console.log(error)
     })
    ...
    render(){
        let articleList = this.state.politics.map((article,index) => {
            return (
