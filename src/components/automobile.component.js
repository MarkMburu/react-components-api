...
export default class Automobile extends Component{
    ...
    componentDidMount(){
     axios.get("https://cors-anywhere.herokuapp.com/http://newsfeedbuzz.herokuapp.com/automobile")
     .then(response => {
         console.log(response.data)
         this.setState({automobile: response.data})
     })
     .catch((error)=>{
         console.log(error)
     })
    ...
    render(){
        let articleList = this.state.automobile.map((article,index) => {
            return (
