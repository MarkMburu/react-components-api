...
export default class Corona extends Component{
    ...
    componentDidMount(){
     axios.get("https://cors-anywhere.herokuapp.com/http://newsfeedbuzz.herokuapp.com/corona")
     .then(response => {
         console.log(response.data)
         this.setState({corona: response.data})
     })
     .catch((error)=>{
         console.log(error)
     })
    ...
    render(){
        let articleList = this.state.corona.map((article,index) => {
            return (
