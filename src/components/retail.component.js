...
export default class Retail extends Component{
    ...
    componentDidMount(){
     axios.get("https://cors-anywhere.herokuapp.com/http://newsfeedbuzz.herokuapp.com/retail")
     .then(response => {
         console.log(response.data)
         this.setState({retail: response.data})
     })
     .catch((error)=>{
         console.log(error)
     })
    ...
    render(){
        let articleList = this.state.retail.map((article,index) => {
            return (
